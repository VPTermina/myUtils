 ...
 * This library will provide all infomation for media files (video, photo, audio)
 * Mediainfo.dll is needed. Please download it from https://mediaarea.net/de/MediaInfo/Download
 * <p>MediInfo.dll should be available in system path (ex. c:\windows\system32)
 * @see #video_general
 *
 * @version 1.0
 * @author Rocco.Gallas@gallas-it.de
 *
 */
...
Forced : No 
	...
	/**
	 * Returns meta information as string (depreciated)
	 * @return tbc
	 */
